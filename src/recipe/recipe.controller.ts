...
export class RecipeController {
  ...
  createRecipe(@User('id') userId: string, @Body() data: RecipeDTO) {
  ...
  @UseGuards(AuthGuard)
  @UsePipes(ValidationPipe)
  destroyRecipe(@Param('id') id: string, @User('id') userId: string) {
  ...
  @Post(':id/upvote')
  @UseGuards(AuthGuard)
  upvoteRecipe(@Param('id') id: string, @User('id') userId: string) {
    this.logData({ id, userId });
  ...
  @Post(':id/downvote')
  @UseGuards(AuthGuard)
  downvoteRecipe(@Param('id') id: string, @User('id') userId: string) {
    this.logData({ id, userId });
  ...
  @Post(':id/bookmark')
  @UseGuards(AuthGuard)
  bookmarkRecipe(@Param('id') id: string, @User('id') userId: string) {
    this.logData({ id, userId });
  ...
  @Delete(':id/bookmark')
  @UseGuards(AuthGuard)
  unbookmarkRecipe(@Param('id') id: string, @User('id') userId: string) {
    this.logData({ id, userId });
